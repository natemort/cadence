...
import (
	...
	_sourceAdmin "github.com/uber/cadence/service/frontend/admin"
)

// adminHandler frontend handler wrapper for authentication and authorization
type adminHandler struct {
	handler    _sourceAdmin.Handler
	authorizer authorization.Authorizer
	resource.Resource
}

// NewAdminHandler creates frontend handler with authentication support
func NewAdminHandler(handler _sourceAdmin.Handler, resource resource.Resource, authorizer authorization.Authorizer, cfg config.Authorization) _sourceAdmin.Handler {
	if authorizer == nil {
		var err error

...
func NewAPIHandler(handler _sourceApi.Handler, logger log.Logger, metricsClient metrics.Client, domainCache cache.DomainCache, cfg *config.Config) _sourceApi.Handler {
	return &apiHandler{
		handler:         handler,
		logger:          logger,

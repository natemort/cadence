...
import (
	...
	_sourceAdmin "github.com/uber/cadence/client/admin"
	"github.com/uber/cadence/common/metrics"
	"github.com/uber/cadence/common/types"
)

// adminClient implements _sourceAdmin.Client interface instrumented with retries
type adminClient struct {
	client        _sourceAdmin.Client
	metricsClient metrics.Client
}

// NewAdminClient creates a new instance of adminClient with retry policy
func NewAdminClient(client _sourceAdmin.Client, metricsClient metrics.Client) _sourceAdmin.Client {
	return &adminClient{
		client:        client,

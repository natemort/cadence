...
import (
	...
	_sourceFrontend "github.com/uber/cadence/client/frontend"
	"github.com/uber/cadence/common/metrics"
	"github.com/uber/cadence/common/types"
)

// frontendClient implements _sourceFrontend.Client interface instrumented with retries
type frontendClient struct {
	client        _sourceFrontend.Client
	metricsClient metrics.Client
}

// NewFrontendClient creates a new instance of frontendClient with retry policy
func NewFrontendClient(client _sourceFrontend.Client, metricsClient metrics.Client) _sourceFrontend.Client {
